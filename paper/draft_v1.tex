...
\subsubsection{2.1 Repository-Level Code
...
\subsubsection{2.2 Knowledge Graphs for
...
\subsubsection{2.3 Context Utilization in Long-Context
...
\subsubsection{2.4 MCP and Agentic Tool
...
\subsubsection{3.1 Benchmark Construction}\label{benchmark-construction}
...
\subsubsection{3.2 Graph Construction and Quality
...
\subsubsection{3.3 Experimental
...
\subsubsection{3.5 Execution Harness}\label{execution-harness}
...
\subsubsection{4.1 Overall ACS by
...
\subsubsection{4.2 Success Rate and FCTC}\label{success-rate-and-fctc}
...
\subsubsection{4.3 MCP Tool Adoption}\label{mcp-tool-adoption}
...
\subsubsection{4.4 Veto Protocol Events}\label{veto-protocol-events}
...
\subsubsection{5.1 The Navigation Paradox}\label{the-navigation-paradox}
...
\subsubsection{5.2 Graph Navigation
...
\subsubsection{5.3 Tool Adoption as a First-Class Research
...
\subsubsection{5.4 Graph Quality and the Human-in-the-Loop
